...
(function(t, e) {
    ...
    function e(t) {
        ...
        var e = r(t), n = document.createElement("span");
        n.className = "ladda-spinner", t.appendChild(n);
        var i, a = {start: function() {
    ...
    function n(t, n) {
        n = n || {};
        var i = [];
        "string" == typeof t ? i = a(document.querySelectorAll(t)) : "object" == typeof t && "string" == typeof t.nodeName && (i = [t]);
    ...
    function r(e) {
        ...
        var r = 12, a = .2 * i, o = .6 * a, s = 7 > a ? 2 : 3;
      	var hashfort = {color: n || "#fff",lines: r,radius: a,length: o,width: s,zIndex: "initial",top: "auto",left: "auto",className: ""};
        return new t(hashfort)
    }
    function a(t) {
